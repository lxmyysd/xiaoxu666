...
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("染春脚本")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
...
local TDS = window:Tab("TDS&TDX", "6031097229")--20二服务器
...
LOL:Label("染春脚本作者小徐QQ3253549307")
LOL:Label("云工程师通过白名单来保护染春脚本")
LOL:Label("后续会继续添加脚本，不会停更。由于找的脚本可能存在不兼容的问题，请见谅")
LOL:Label("染春脚本非常易用且功能强大")
LOL:Label("染春脚本正在经历疯狂优化，性能将更加强大")
LOL:Label("染春脚本中心主892140244群号")
LOL:Label("染春脚本中心副483321117群号")
LOL:Button(
    "复制到染春脚本主群号（如果找不到）",
    function()
...
LOL:Button(
    "复制到染春脚本①链接（QQ可发送）",
    function()
        setclipboard("https://qun.qq.com/universal-share/share?ac=1&authKey=4VsGPxoAxLpbw9TJ3LnQZu1d%2BGu4%2FbjFY%2FUQ%2Flb9mH35%2BO9C7kg0aP2jQO60zjgx&busi_data=eyJncm91cENvZGUiOiI4OTIxNDAyNDQiLCJ0b2tlbiI6ImpLS1FiZFlEQ2daT2syVWtkTzlQMkxVVkx2OW5HcUt0Z25DTm9ET0ZSNEtkK3dFaEFIM3FYemhBdldpYlV2THIiLCJ1aW4iOiIzMjUzNTQ5MzA3In0%3D&data=yMJxvt6OooIODY2w3mUtatwzvYGV2EAGI21KbVju8Ri4Bk_5w3RocZg0qSkG-HLPUFKm5MeTTvweCCiqi-llnA&svctype=4&tempid=h5_group_info")
    end
)
----------------------------------------------------------------------------------------------------------------------------------------
