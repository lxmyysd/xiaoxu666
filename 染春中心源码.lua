...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『染春中心』"; Text ="核对用户ID中♧"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『染春中心』"; Text ="用户ID核对完毕♣"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/hun/main/jmlibrary1.lua"))();        
local win = ui:new("染春中心")
--
...
about:Label("染春主群：16060333448")
about:Label("矢井凛主群： 961174607")
about:Label("矢井凛副群： 1057418314")
about:Label("矢井凛三群： 1057418314")
about:Label("矢井凛四群： 992752689")
about:Label("作者：小徐")
about:Label("进群发最新")
about:Label("脚本持续更新中")
about:Label("脚本疯狂优化中")
...
about:Label("感谢所有支持染春中心的人")
about:Label("已修复完bug")
about:Label("♦")
about:Label("QQ群961174607")
about:Label("感谢大家支持染春中心")
about:Label("十分感谢")
about:Label("感谢中透明,小透明,以实玛利,神不如风,小皮支持我做下去")
